...
public class GetRunningConfig {
    Binding binding;
    CLIConnection connection;
    GroovyScriptEngine gse;
    static Logger logger = Logger.getLogger(GetRunningConfig.class);
    ...
    public static void main(String[] args) throws IOException, ResourceException, ScriptException,RuntimeException {
        ...
        GetRunningConfig launcher = new GetRunningConfig();
        ...
        if (loginResult.get("status") == Status.failure) {
            ...
            if(result.get("status")==Status.success){
                System.out.println("Router Configuration is\n"+ result.get("data"));
            }else{
                System.out.println("Command failed:"+ result.get("status"));
